...
const originalData = {
  '1k': [
    { category: 'NCF', NCCL: 50, DHC: 22.7 },
    { category: 'LSTM', NCCL: 150, DHC: 107.1 },
    { category: 'VGG16', NCCL: 1380, DHC: 373.0 },
    { category: 'VGG19', NCCL: 1430, DHC: 376.3 },
    { category: 'BERT-base', NCCL: 1100, DHC: 916.7 }
  ]
}
...
const chartOptions = computed(() => {
  ...
  const algorithms = ['NCCL', 'DHC']
  const dataKeys = ['NCCL', 'DHC']
